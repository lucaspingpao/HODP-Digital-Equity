...
# setwd("~/Documents/HODP-Digital-Equity")
...
# Change 11-04-20
colnames(data)[9] <- "Types.of.connection"

# Section 1 ---------------------------------------------------------------

section1 <- data[c(1:9, 21)]
...
# Change 11-04-20
serviceTypes[5] <- "Unhoused Services \n Provider"
...
connection <- c("No internet", "Cell phone data only", "Hotspot", "Comcast", "Starry", "Verizon", "Public wifi")
connectionValues <- 1:length(connection); connectionValues
for(i in 1:length(connection)) {
  connectionValues[i] <- nrow(subset(section1, str_detect(section1$"Types.of.connection", connection[i])))
}
connection[2] <- "Cell phone \n data only"

##################################################
# Plots
par(bg = "#F2F2F2", ps=11, mar=c(2,2,2,2))
png(file="~/Documents/HODP-Digital-Equity/section1_Services_Barplot.png", width=1000, height=500)
g <- barplot(height=serviceTypesValues, names.arg=serviceTypes, las=1, ylim=c(0,20), ylab="Frequency",
        main="What type of services does your organization provide?", col="#595959", font.main=2, cex.main=2.25, cex.lab=1.25, cex.axis=1.5, cex.names=0.95)
dev.off()

png(file="~/Documents/HODP-Digital-Equity/section1_Internet_Barplot.png")
...
png(file="~/Documents/HODP-Digital-Equity/section1_Device_Barplot.png")
...
png(file="~/Documents/HODP-Digital-Equity/section1_Sufficient_Barplot.png")
...
png(file="~/Documents/HODP-Digital-Equity/section1_ConnectionType_Barplot.png")
g <- barplot(height=connectionValues, names.arg=connection, las=1, ylim=c(0, 40), ylab="Frequency",
        main="For clients without sufficient internet connection, \n what type of connection is your client using?",col="#595959", font.main=2)
dev.off()
##################################################
